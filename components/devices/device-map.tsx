...
const LeafletMapComponent: React.FC<{
    ...
    currentBearing
      ...
      `,
        ...
        // Crear icono personalizado usando el pin de ubicación proporcionado por el usuario
        const createCustomIcon = (rotation = 0) => {
            const iconColor = isConnected ? '#10B981' : '#FF3D00'; // Verde si conectado, naranja/rojo si no
            const pulseColor = isConnected ? 'rgba(16, 185, 129, 0.3)' : 'rgba(255, 61, 0, 0.3)';
            const shadowColor = isConnected ? 'rgba(16, 185, 129, 0.2)' : 'rgba(255, 61, 0, 0.2)';
        ...
        ">
          ...
          <svg width="32" height="32" viewBox="0 0 1024 1024" style="
            position: absolute;
            top: 0;
            left: 0;
          ...
          ">
            ...
            <circle cx="512" cy="400" r="200" fill="url(#pulseGlow)" opacity="0.6"/>
            ...
            <path d="M512 85.333333c-164.949333 0-298.666667 133.738667-298.666667 298.666667 0 164.949333 298.666667 554.666667 298.666667 554.666667s298.666667-389.717333 298.666667-554.666667c0-164.928-133.717333-298.666667-298.666667-298.666667z m0 448a149.333333 149.333333 0 1 1 0-298.666666 149.333333 149.333333 0 0 1 0 298.666666z" 
                  fill="${iconColor}" stroke="#ffffff" stroke-width="20"/>
          </svg>
          ...
          <style>
            @keyframes locationPulse {
              ...
              50% { 
                filter: drop-shadow(0 4px 12px ${shadowColor.replace('0.2', '0.4')});
                transform: scale(1.1);
              }
            }
          </style>
